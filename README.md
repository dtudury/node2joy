...
~~~sh
git clone git@github.com:nko3/node-to-joy.git
~~~
...
~~~sh
npm install -g jitsu
jitsu login --username nko3-node-to-joy --password ga7cohpePCAMrnTt
jitsu deploy
~~~
...
~~~html
<iframe src="http://nodeknockout.com/iframe/node-to-joy" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
...
[2]: https://github.com/organizations/nko3/teams/280936
[3]: https://github.com/nko3/node-to-joy
